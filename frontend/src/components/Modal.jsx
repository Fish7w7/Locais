    ...
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-y-auto">
        <div className="flex min-h-full items-end sm:items-center justify-center p-0 sm:p-4">
          <div className={`relative bg-white dark:bg-gray-800 w-full ${sizeClasses[size]} transform transition-all rounded-t-2xl sm:rounded-lg shadow-xl max-h-[92vh] sm:max-h-[90vh] flex flex-col`}>
            {/* Header - Fixo */}
