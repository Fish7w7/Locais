...
const Button = ({ 
  ...
  const variantClasses = { primary: 'bg-primary-600 hover:bg-primary-700 active:bg-primary-800 text-white disabled:bg-primary-300 disabled:cursor-not-allowed',
  ...
  const sizeClasses = { sm: 'px-3 py-2 text-sm min-h-[40px]',
